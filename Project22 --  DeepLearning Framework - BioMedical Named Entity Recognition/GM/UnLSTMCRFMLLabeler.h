...
#include "N3L.h"
#include "basic/UnLSTMCRFMLClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  UnLSTMCRFMLClassifier<gpu> m_classifier;
#else
  UnLSTMCRFMLClassifier<cpu> m_classifier;
#endif
...
public:
  void train(const string& trainFile, const string& devFile, const string& testFile, const string& modelFile, const string& optionFile, const string& wordEmbFile, const string& charEmbFile, const string& c2_devoutFile, const string& c2_testoutFile);
